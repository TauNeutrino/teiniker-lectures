...
{			
	@Test
	public void testDES_ECB() 
		throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException, ShortBufferException, IllegalBlockSizeException, BadPaddingException, NoSuchProviderException 
	{
...
//		byte[] ivBytes = new byte[8]; // Cipher block size
