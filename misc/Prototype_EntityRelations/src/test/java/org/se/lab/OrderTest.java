...
//		order.addOrderLine(new OrderLine(4, 2, new Product(5, "Pizza Quattro Formaggi", 820)));
		OrderLine line1 = new OrderLine(2, 1);
		line1.setProduct(new Product(3, "Pizza Frutti di Mare", 880));
		OrderLine line2 = new OrderLine(4, 2);
		line2.setProduct(new Product(5, "Pizza Quattro Formaggi", 820));
